package ru.yandex.practicum.commerce.shoppingstore.exceprion;
...
public class ShoppingCartNotFoundException extends RuntimeException {
    ...
    @Builder
    private ShoppingCartNotFoundException(String message, String userMessage, HttpStatus httpStatus, Throwable cause) {
        super(message, cause);
