...
-- Таблица адресов
CREATE TABLE shopping_store.addresses (
...
-- Таблица доставок
CREATE TABLE shopping_store.deliveries (
...
CREATE INDEX idx_deliveries_order_id ON shopping_store.deliveries(order_id);
CREATE INDEX idx_deliveries_state ON shopping_store.deliveries(state);
CREATE INDEX idx_deliveries_from_address ON shopping_store.deliveries(from_address_id);
CREATE INDEX idx_deliveries_to_address ON shopping_store.deliveries(to_address_id);